...
def change_pic():
    imgs = [
        ImageTk.PhotoImage(Image.open('1.png')),
        ImageTk.PhotoImage(Image.open('2.png')),
        ImageTk.PhotoImage(Image.open('3.png')),
        ImageTk.PhotoImage(Image.open('4.png')),
        ImageTk.PhotoImage(Image.open('5.png')),
        ImageTk.PhotoImage(Image.open('6.png'))]
    root.x = choice(imgs)
